...
{
    public class ClienteDtoToEmpeladoResolver : IValueResolver<EmpleadoDTO, EmpleadoDto, Cliente>
    {
        ...
        public Cliente Resolve(EmpleadoDTO source, EmpleadoDto destination, Cliente destMember, ResolutionContext context)
        {
