...
{
    public class CreateInfoAsentadaDtoToAlquiler : IValueResolver<CreateAlquilerDto, Domain_Layer.Entidades.Alquiler, ICollection<InfoAsentada>>
    {
        private readonly ApplicationDbContext _context;
        private readonly IMapper _mapper;
        public CreateInfoAsentadaDtoToAlquiler(ApplicationDbContext context, IMapper mapper)
        {
            _context = context;
            _mapper = mapper;
        }

        public ICollection<InfoAsentada> Resolve(CreateAlquilerDto source, Domain_Layer.Entidades.Alquiler destination, ICollection<InfoAsentada> destMember, ResolutionContext context)
        {
