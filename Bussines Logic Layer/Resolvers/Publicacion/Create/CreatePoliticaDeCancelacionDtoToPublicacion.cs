...
{
    class CreatePoliticaDeCancelacionDtoToPublicacion : IValueResolver<CreatePublicacionDto, Domain_Layer.Entidades.Publicacion, PoliticaDeCancelacion>
    {
        private readonly ApplicationDbContext _context;
        private readonly IMapper _mapper;

        public CreatePoliticaDeCancelacionDtoToPublicacion(ApplicationDbContext context, IMapper mapper)
        {
            _mapper = mapper;
            _context = context;
        }

        public PoliticaDeCancelacion Resolve(CreatePublicacionDto source, Domain_Layer.Entidades.Publicacion destination
