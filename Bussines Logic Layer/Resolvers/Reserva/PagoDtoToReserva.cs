...
{
    public class PagoDtoToReserva : IValueResolver<ReservaDto, Domain_Layer.Entidades.Reserva , Pago>
    {
        private readonly ApplicationDbContext _context;
        private readonly IMapper _mapper;

        public PagoDtoToReserva(ApplicationDbContext context, IMapper mapper)
        {
            _mapper = mapper;
            _context = context;
        }

        public Pago Resolve(ReservaDto source, Domain_Layer.Entidades.Reserva destination
