...
{
    public class PublicacionDtoToReserva : IValueResolver<ReservaDto, Domain_Layer.Entidades.Reserva , Domain_Layer.Entidades.Publicacion>
    {
        private readonly ApplicationDbContext _context;
        private readonly IMapper _mapper;

        public PublicacionDtoToReserva(ApplicationDbContext context, IMapper mapper)
        {
            _mapper = mapper;
            _context = context;
        }

        public Domain_Layer.Entidades.Publicacion Resolve(ReservaDto source, Domain_Layer.Entidades.Reserva destination
