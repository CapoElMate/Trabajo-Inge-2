...
{
    public class CreateTipoEntregaDtoToReserva : IValueResolver<CreateReservaDto, Domain_Layer.Entidades.Reserva, TipoEntrega>
    {
        private readonly ApplicationDbContext _context;
        private readonly IMapper _mapper;

        public CreateTipoEntregaDtoToReserva(ApplicationDbContext context, IMapper mapper)
        {
            _mapper = mapper;
            _context = context;
        }

        public TipoEntrega Resolve(CreateReservaDto source, Domain_Layer.Entidades.Reserva destination
