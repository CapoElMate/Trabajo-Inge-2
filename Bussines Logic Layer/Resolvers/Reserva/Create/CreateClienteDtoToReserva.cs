...
{
    public class CreateClienteDtoToReserva : IValueResolver<CreateReservaDto, Domain_Layer.Entidades.Reserva , Cliente>
    {
        private readonly ApplicationDbContext _context;
        private readonly IMapper _mapper;

        public CreateClienteDtoToReserva(ApplicationDbContext context, IMapper mapper)
        {
            _mapper = mapper;
            _context = context;
        }

        public Cliente Resolve(CreateReservaDto source, Domain_Layer.Entidades.Reserva destination
